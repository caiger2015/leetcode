...
public class LinkedListCycle2 {
	 ...
	 * 重新分析快慢指针的过程，a为head到入口节点，b为入口下一个到相遇节点，c为相遇下一个到入口在环中的上一个
	 * q = 2s,q = a+b+c+b,s = a+b,所以c=a；说明在相遇的时候，相遇节点到环入口节点的距离等于head到入口的距离
	 * @param head
	 * @return
	 */
	...
	/**
	 * @param slow 环中相遇的节点的下一个节点，相遇节点是两路的尾结点
	 * @param head
	 * @param c 环中结点数，也是第二路链表的节点数
	 * @param s	第一路链表的节点数
	 * @return
	 */
