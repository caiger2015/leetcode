...
public class MedianOfTwoSortedArrays {
	...
	public static void main(String[] args) {
		...
		System.out.print(findMedianSortedArrays(new int[]{1,4,5,6,9},new int[]{2,3,7,8}));
	}
	 ...
	 * 1.边界条件（重点先考虑的）:有一个空，直接返回另一个的第K个（这里的K是递归里的）；
	 * 			  k<=1时，返回此时比较的两个数中小的那个
	 * 			  若比较的两个相等，说明刚好合并之后是第k个，返回其中一个
	 * 2.问题转化（递归）：更新递归函数的参数
	 * @param A B 是查找的数组
	 * @param m n 是它俩的长度
	 * @param k   是要找的第k个数
